...
apptr100 = dash.Dash(__name__,title="Traspasos", external_stylesheets=[dbc.themes.MORPH, dbc.icons.FONT_AWESOME],requests_pathname_prefix='/traspasos100/')
...
apptr100.layout = html.Div([dcc.Location(id="url"),contenidox])

@apptr100.callback(Output("page-content", "children"), Input("url", "pathname"))
...
@apptr100.callback([Output("table","data"),Output("table","columns"),Output("table","page_size")], [Input('radioGaga','value'),Input('dCD','value'), Input('dDepto','value'), Input('dInstalacion','value')])
...
if __name__ == "__main__":
    apptr100.run_server(debug=True)