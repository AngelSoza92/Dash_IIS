...
def get_df8():
    return pd.read_sql_query("SELECT ETA_CLIENTE,PATENTE ,GUIA  ,HOJA_RUTA    ,RUT_EMP     ,DESC_EMP    ,ESTADO    ,SUB_ESTADO     ,NOMBRE_CLIENTE   ,DIRECCION_CLIENTE    ,NUMSOLGUI    ,CODREGI   ,LOCALDESPA    ,FECSOLDES   ,QTY*1 as QTY    ,FLUJO  from CURRENT_GUIAS_FPM", conexion)