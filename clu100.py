...
appc100 = dash.Dash(__name__,title="CLU", external_stylesheets=[dbc.themes.MORPH, dbc.icons.FONT_AWESOME],requests_pathname_prefix='/asdf/')
PLOTLY_LOGO = "http://10.107.226.241/assets/caja.png"


contenidox = html.Div(id='page-content',children=[])
appc100.layout = html.Div([dcc.Location(id="url"),contenidox])

@appc100.callback(Output("page-content", "children"), Input("url", "pathname"))
...
@appc100.callback([Output("table","data"),Output("table","columns"),Output("table","page_size")], [Input('radioGaga','value'),Input('dCD','value'), Input('dFecha','value'), Input('dTipood','value'), Input('dFlujo','value'),Input('dTipoola','value'),Input('dRetira','value'),Input('dEspecial','value'),Input('dOla','value')])
